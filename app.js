...
let inputYearValue = inputYear.value;
    ...
    if(inputYearValue > currentYear){
        inputYearValue.style.border = '1px solid red';
        console.log(inputYearValue > currentYear)
    }

    // if(currentMonth < inputMonthValue){
        //inputYearValue = inputYearValue - 1; 
        //inputMonthValue = inputMonthValue + 12;
        //outputDay.innerHTML = 'inputMonthValue';
    // }
